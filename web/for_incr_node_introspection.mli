...
(** [run_top_level_side_effects] registers the callbacks necessary for introspection to work/sets up the
    ...
    communication mechanisms setup by [run_top_level_side_effects]. *)
